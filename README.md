...
1. 
**Hardware Input Reading**: The ESP32 continuously reads the manual knobs (potentiometers) simulating throttle behavior, rider weight, and outside temperature.


2. 
**Drivetrain Simulation**: The inputs feed into the live powertrain model, computing how fast the scooter moves and how much heat the battery produces under that specific demand.
